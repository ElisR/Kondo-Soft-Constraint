...
\date{\today}
\author{\textbf{Elis Roberts} - \textit{supervised by} Claudio Castelnovo \textit{\&} Garry Goldstein} % Should probably include supervisors
\institute{University of Cambridge}
\titlegraphic{\hfill\includegraphics[height=1cm]{Figures/croc_dima.eps}}
